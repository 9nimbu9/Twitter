...
function HomeInfo(props) {
    ...
    return (
        <div className="leftHandSide">
            <div>
                <svg viewBox="0 0 24 24" width="30" aria-hidden="true" className="homeInfoIcon r-13v1u17 r-4qtqp9 r-yyyyoo r-16y2uox r-8kz0gk r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-lrsllp">
                ...
                <Link
                    ...
                    <svg viewBox="0 0 24 24" width="30" aria-hidden="true" className="homeInfoIcon r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                ...
                <br></br>
                <svg viewBox="0 0 24 24" width="30" aria-hidden="true" className="homeInfoIcon r-jwli3a r-4qtqp9 r-yyyyoo r-1472mwg r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-lrsllp">
